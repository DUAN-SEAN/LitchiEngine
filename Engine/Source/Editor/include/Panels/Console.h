...
namespace LitchiEditor
{
	...
	public:
		...
		* @param p_logData
		*/
		void OnLogIntercepted(const LitchiRuntime::LogData& p_logData);
		...
		* @param p_logLevel
		*/
		bool IsAllowedByFilter(LitchiRuntime::ELogLevel p_logLevel);
	...
	private:
		...
		std::unordered_map<LitchiRuntime::TextColored*, LitchiRuntime::ELogLevel> m_logTextWidgets;
