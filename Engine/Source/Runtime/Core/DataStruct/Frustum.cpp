...
/////////////////////////////////// POINT IN FRUSTUM \\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\*
//
//bool LitchiRuntime::Frustum::PointInFrustum(float x, float y, float z) const
//{
...
/////////////////////////////////// SPHERE IN FRUSTUM \\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\*
//
//bool LitchiRuntime::Frustum::SphereInFrustum(float x, float y, float z, float radius) const
//{
...
/////////////////////////////////// CUBE IN FRUSTUM \\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\*
//
//bool LitchiRuntime::Frustum::CubeInFrustum(float x, float y, float z, float size) const
//{
...
//}
//
//std::array<float, 4> LitchiRuntime::Frustum::GetNearPlane() const
//{
//	return { m_frustum[FRONT][0], m_frustum[FRONT][1], m_frustum[FRONT][2], m_frustum[FRONT][3] };
//}
//
//std::array<float, 4> LitchiRuntime::Frustum::GetFarPlane() const
//{
