...
LitchiRuntime::FileDialog::FileDialog(std::function<int(tagOFNA*)> p_callback, const std::string & p_dialogTitle) :
...
void LitchiRuntime::FileDialog::SetInitialDirectory(const std::string & p_initialDirectory)
{
	m_initialDirectory = p_initialDirectory;
}

void LitchiRuntime::FileDialog::Show(EExplorerFlags p_flags)
{
	OPENFILENAME ofn;
...
bool LitchiRuntime::FileDialog::HasSucceeded() const
{
	return m_succeeded;
}

std::string LitchiRuntime::FileDialog::GetSelectedFileName()
{
	return m_filename;
}

std::string LitchiRuntime::FileDialog::GetSelectedFilePath()
{
	return m_filepath;
}

std::string LitchiRuntime::FileDialog::GetErrorInfo()
{
	return m_error;
}

bool LitchiRuntime::FileDialog::IsFileExisting() const
{
	return std::filesystem::exists(m_filepath);
}

void LitchiRuntime::FileDialog::HandleError()
{
