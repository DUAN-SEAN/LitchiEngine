...
//
//		const Quaternion Identity = Quaternion(1.0f, 0.0f, 0.0f, 0.0f);
//
//		Quaternion Lerp(Quaternion& p_start, Quaternion& p_end, float p_alpha)
//		{
...
//		}
//
//		Quaternion LookAt(const Vector3& p_forward, const Vector3& p_up)
//		{
