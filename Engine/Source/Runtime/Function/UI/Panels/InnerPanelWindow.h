...
namespace LitchiRuntime
{
	...
	*/
	class InnerPanelWindow :public WidgetContainer, public AWidget
	{
	public:
		/**
		* Creates the InnerPanelWindow
		* @param p_name
		* @param p_opened
		* @param p_size
		* @param p_color
		...
		*/
		...
		(
			...
			bool p_opened = true,
			const Vector2 p_size = Vector2::Zero,
			const Color& p_color = Color::Black,
