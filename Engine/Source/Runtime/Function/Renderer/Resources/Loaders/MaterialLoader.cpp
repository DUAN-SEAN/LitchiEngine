...
//
//LitchiRuntime::Material* LitchiRuntime::Loaders::MaterialLoader::Create(const std::string & p_path)
//{
...
//}
//
//void LitchiRuntime::Loaders::MaterialLoader::Reload(LitchiRuntime::Material& p_material, const std::string& p_path)
//{
...
//}
//
//void LitchiRuntime::Loaders::MaterialLoader::Save(LitchiRuntime::Material& p_material, const std::string& p_path)
//{
...
//}
//
//bool LitchiRuntime::Loaders::MaterialLoader::Destroy(LitchiRuntime::Material*& p_material)
//{
//	if (p_material)
//	{
//		delete p_material;
