...
LitchiRuntime::Framebuffer::~Framebuffer()
{
...
void LitchiRuntime::Framebuffer::Bind()
{
	glBindFramebuffer(GL_FRAMEBUFFER, m_bufferID);
}

void LitchiRuntime::Framebuffer::Unbind()
{
	glBindFramebuffer(GL_FRAMEBUFFER, 0);
}

void LitchiRuntime::Framebuffer::Resize(uint16_t p_width, uint16_t p_height)
{
	/* Resize texture */
	glBindTexture(GL_TEXTURE_2D, m_renderTexture);
...
uint32_t LitchiRuntime::Framebuffer::GetID()
{
	return m_bufferID;
}

uint32_t LitchiRuntime::Framebuffer::GetTextureID()
{
	return m_renderTexture;
}

uint32_t LitchiRuntime::Framebuffer::GetRenderBufferID()
{
