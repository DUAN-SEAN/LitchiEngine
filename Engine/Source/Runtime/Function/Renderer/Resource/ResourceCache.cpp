...
//	}
//
//	void ResourceCache::Initialize(std::string projectAssetPath)
//	{
//		// Create project directory
//		SetProjectDirectory(projectAssetPath);
//
//		// Add engine standard resource directories
//		const string data_dir = projectAssetPath + "Assets\\";
//		AddResourceDirectory(ResourceDirectory::Environment, m_project_directory + "environment");
//		AddResourceDirectory(ResourceDirectory::Fonts, data_dir + "Engine\\Fonts");
//		AddResourceDirectory(ResourceDirectory::Icons, data_dir + "Engine\\Icons");
//		AddResourceDirectory(ResourceDirectory::ShaderCompiler, data_dir + "Engine\\Shader_compiler");
//		AddResourceDirectory(ResourceDirectory::Shaders, data_dir + "Engine\\Shaders");
//		AddResourceDirectory(ResourceDirectory::Textures, data_dir + "Engine\\Textures");
//
//		// Subscribe to events
