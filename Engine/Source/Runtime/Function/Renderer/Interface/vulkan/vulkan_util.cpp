...
namespace LitchiRuntime
{
                                        ...
                                        VkMemoryPropertyFlags properties_flag)
    {
        ...
        DEBUG_LOG_ERROR("findMemoryType error");
        return 0;
    }
                                       ...
                                       int                   datasize)
    {
        ...
        {
            DEBUG_LOG_ERROR("create buffer buffer failed!");
            return;
        }
        ...
        if (!memTypeFound)
        {
            DEBUG_LOG_ERROR("memTypeFound is nullptr");
            return;
        }
        if (VK_SUCCESS != vkAllocateMemory(device, &memAlloc, nullptr, memory))
        {
            DEBUG_LOG_ERROR("alloc memory failed!");
            return;
        }
        ...
        if (data != nullptr && datasize != 0)
        {
            ...
            {
                DEBUG_LOG_ERROR("map memory failed!");
                return;
            }
        ...
        {
            DEBUG_LOG_ERROR("bind memory failed!");
            return;
        }
    }
                                  ...
                                  VkDeviceMemory&       buffer_memory)
    {
        ...
        {
            DEBUG_LOG_ERROR("vkCreateBuffer failed!");
            return;
        }
        ...
        {
            DEBUG_LOG_ERROR("vkAllocateMemory failed!");
            return;
        }
                                ...
                                VkDeviceSize size)
    {
        if (rhi == nullptr)
        {
            DEBUG_LOG_ERROR("rhi is nullptr");
            return;
        }
                                 ...
                                 uint32_t              miplevels)
    {
        ...
        {
            DEBUG_LOG_ERROR("failed to create image!");
            return;
        }
        ...
        {
            DEBUG_LOG_ERROR("failed to allocate image memory!");
            return;
        }
                                       ...
                                       uint32_t           miplevels)
    {
        ...
        switch (texture_image_format)
        {
            ...
            case RHIFormat::RHI_FORMAT_R32G32B32A32_SFLOAT:
                ...
                break;
            default:
                DEBUG_LOG_ERROR("invalid texture_byte_size");
                break;
        }
                                   ...
                                   uint32_t             miplevels)
    {
        ...
        switch (texture_image_format)
        {
            ...
            default:
                ...
                DEBUG_LOG_ERROR("invalid texture_layer_byte_size");
                return;
                break;
        }
                                            ...
                                            uint32_t miplevels)
    {
        ...
        {
            DEBUG_LOG_ERROR("generateTextureMipMaps() : linear bliting not supported!");
            return;
        }
                                           ...
                                           VkImageAspectFlags aspect_mask_bits)
    {
        ...
        {
            DEBUG_LOG_ERROR("unsupported layout transition!");
            return;
        }
    ...
    VkSampler VulkanUtil::getOrCreateNearestSampler(VkPhysicalDevice physical_device, VkDevice device)
    {
        if (m_nearest_sampler == VK_NULL_HANDLE)
        {
            ...
            {
                DEBUG_LOG_ERROR("vk create sampler");
            }
        }
