...
namespace LitchiRuntime
{
    ...
    void Physics::SetLinearVelocity(PxRigidDynamic* actor, const Vector3& velocity)
    {
        if (actor != nullptr)
        {
    ...
    void Physics::SetAngularVelocitySet(PxRigidDynamic* actor, const Vector3& velocity)
    {
        if (actor != nullptr)
        {
